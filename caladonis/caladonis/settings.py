...
dev_mode = bool(os.getenv('DJANGO_DEVELOPMENT'))
...
ROOT_URLCONF = 'caladonis.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'caladonis/templates/')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'caladonis.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        'writeToFile': {
            ...
            'filename': os.path.join(BASE_DIR, '../logs/workouts/views.log'),
